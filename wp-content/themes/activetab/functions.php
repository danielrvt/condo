...
if (!function_exists('activetab_register_widgets')) :
    function activetab_register_widgets()
    {
        ...
        register_sidebar(array(
            'name' => __('Información de pagos', 'activetab'),
            'id' => 'payment-info',
            'description' => 'Información mostrada en la pantalla de pagos',
            'before_widget' => '<aside id="%1$s" class="widget %2$s">',
            'after_widget' => '</aside>',
            'before_title' => '<h4 class="widget-title">',
            'after_title' => '</h4>',
...
if (!function_exists('activetab_list_pages')) :
    ...
    {
        ?>
        <nav class="nav-menu nav clearfix" role="navigation">
                    ...
                    <article id="comment-<?php comment_ID(); ?>" class="clearfix">
                        <header class="comment-header">
                            ...
                            <?php if ($comment->comment_approved == '0') : ?>
                                <p>
                                    <em class="comment-awaiting-moderation"><?php _e('Your comment is awaiting moderation.', 'activetab'); ?></em>
                                </p>
                            <?php endif; ?>
...
if (!function_exists('activetab_post_author')) :
    function activetab_post_author()
    { // author
        global $authordata;
...
if (!function_exists('activetab_post_categories')) :
    function activetab_post_categories()
    { // list of categories
...
if (!function_exists('activetab_nav')) :
    function activetab_nav($class = 'top')
    { // show next/prev navigation links when needed
        global $wp_query;
        $nav = '';
...
if (!function_exists('activetab_excerpt_more')) :
    function activetab_excerpt_more($more)
    { // "more-link" is bad for seo and for usability - http://web-profile.com.ua/web/web-principles/more-link/
        return '...';
    }
...
if (!function_exists('activetab_wp_head')) :
    function activetab_wp_head()
    { // output content to the head section
...
if (!function_exists('activetab_admin_head')) :
    function activetab_admin_head()
    { // output content to the admin head section
...
if (!function_exists('activetab_wp_footer')) :
    function activetab_wp_footer()
    { // output content to the footer section
...
{ // set theme option name to 'activetab_options' and save all options there
...
function activetab_optionscheck_change_santiziation()
{ // remove default and add custom filter for textarea in options framework
...
function activetab_custom_sanitize_textarea($input)
{ // allow script and style tags for textarea
